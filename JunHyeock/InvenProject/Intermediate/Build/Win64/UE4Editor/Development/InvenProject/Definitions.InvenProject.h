...
#define UE_PROJECT_NAME InvenProject
#define UE_TARGET_NAME InvenProjectEditor
#define UE_MODULE_NAME "InvenProject"
...
#define INVENPROJECT_API DLLEXPORT
